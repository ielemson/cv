                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-6">
                                            <input id="name" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" required autocomplete="blog title" placeholder="Blog Title" autofocus>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea class="form-control @error('body') is-invalid @enderror" name="body" value="{{ old('body') }}" required placeholder="Write your blog here......" ></textarea>
